...
| GAP-010 | `NEEDS SME CONFIRMATION` | Does `clinical-rules.md` §21 data association govern AC-003 to AC-005, or only clinical actions? The Client/Patient identity decision of 2026-08-24 makes §21 applicable in principle; what remains is whether showing another client's data in a read-only view is a §21 association failure or a lesser context error. See the CL-002 note in §8. | AC-003 to AC-005, §8, and Gate G7 | Independent Clinical SME — **not yet named** | 2026-08-25 | Partially answered: §21 applies to Client records. Severity for read-only views still open. Routed to an independent Clinical SME on 2026-08-25; QA declined to answer it, on the grounds that the sign-off precedent set for this requirement covered read-only scope and not the clinical severity of cross-client data exposure. | `NOT SPECIFIED` |
