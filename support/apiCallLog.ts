...
const CATALOG: Array<{ method: string; template: string; group: GroupName }> = [
  ...
  { method: 'PATCH', template: '/clinical/v1/program-library/:id', group: 'Programs' },
  ...
  { method: 'GET', template: '/clinical/v1/abc-options', group: 'App' },
  { method: 'GET', template: '/clinical/v1/data-collection-scales', group: 'App' },
  { method: 'GET', template: '/clinical/v1/reports/analyze-data/series?clientId=', group: 'App' },
  {
    method: 'GET',
    template: '/clinical/v1/reports/analyze-data/mastered-targets?clientId=',
    group: 'App',
  },
  {
    method: 'GET',
    template: '/clinical/v1/reports/analyze-data/graphs?clientId=&seriesIds=',
    group: 'App',
  },
  { method: 'GET', template: '/clinical/v1/lookup/behavior-categories', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/method-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/consecutive-unit-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/record-results', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/phase-change-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/curriculum-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/lesson-statuses', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/lesson-step-statuses', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/track-intensity-statuses', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/lesson-categories', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/abc-option-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/data-collection-scale-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/goal-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/phase-change-data-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/strategy-types', group: 'App' },
  { method: 'GET', template: '/clinical/v1/lookup/validation-statuses', group: 'App' },
  { method: 'GET', template: '/clinical/healthcheck', group: 'App' },
  { method: 'GET', template: '/clinical/healthcheck/report', group: 'App' },
  {
    method: 'GET',
