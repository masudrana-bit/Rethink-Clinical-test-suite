...
> It incorporates every lesson learned so far (decisions D1–D21).
...
- ☑ Decision log current (D1–D21); flake ~zero as of the Unit 6 baseline (re-open if nightly flakes)
...
> discover anything that contradicts or extends decisions D1–D21, add a new dated decision to
