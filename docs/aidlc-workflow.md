...
5. **Respect the decisions.** Decisions in `coverage-matrix.md` (D1–D21) constrain everything. If you
...
| Decisions D1–D21, tag taxonomy, grounding facts | `docs/coverage-matrix.md` |
